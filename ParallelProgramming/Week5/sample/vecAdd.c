...
int main(void) {
	...
	ret = clEnqueueWriteBuffer(cmd_q, b_mem_obj, CL_TRUE, 0,LIST_SIZE*sizeof(int), B,0,NULL, NULL) ;
	...
	ret = clEnqueueReadBuffer(cmd_q, c_mem_obj, CL_TRUE, 0, LIST_SIZE*sizeof(int), C, 0, NULL, NULL) ;
